...
## ACTIVE DOC MODEL (5 canonical + ограниченный operational reference list)
...
Модель scope согласована с реестром: **5 canonical + ограниченный operational reference list** (см. `docs/library/DOCUMENT_REGISTRY.md`).
