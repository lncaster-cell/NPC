...
2. `docs/canon/17_UNIFIED_GAME_DESIGN_BRIEF_RU.md` — единственный главный дизайн-документ.
3. `docs/entry/12_MASTER_PLAN.md` — краткая сводка и навигационный индекс.
4. `docs/12A–12E`, `docs/canon/13_AGING_AND_CLAN_SUCCESSION.md`, `docs/canon/14_CLAN_SYSTEM_DESIGN.md` — доменная детализация.
