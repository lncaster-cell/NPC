...
> ⚠️ Режим проекта: **documentation-first (reset/rebuild)**. Код предыдущей итерации удалён; библиотека фиксирует и синхронизирует идеи для новой реализации с нуля. См. `docs/18_REBUILD_RESET_CONTEXT.md`.
