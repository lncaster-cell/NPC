...
Дата: 2026-04-02  
Аудитор: Codex  
Связанный отчёт: `docs/27_DEEP_GLOBAL_AUDIT_2026-04-02.md`
...
1. `docs/07_SCENARIOS_AND_ALGORITHMS.md`
2. `docs/10_NPC_RESPAWN_MECHANICS.md`
3. `docs/12A_WORLD_MODEL_CANON.md`
4. `docs/12B_RUNTIME_MASTER_PLAN.md`
5. `docs/12C_PLAYER_PROPERTY_SYSTEM.md`
6. `docs/12D_WORLD_TRAVEL_CANON.md`
7. `docs/16_IDEA_INVENTORY_AND_SYNC_MAP.md`
8. `docs/06_SYSTEM_INVARIANTS.md`
9. `docs/library/IDEA_CARD_TEMPLATE.md`
10. `docs/24_DOCUMENTATION_CODE_INSPECTION_2026-04-01.md`
11. `docs/27_DEEP_GLOBAL_AUDIT_2026-04-02.md` (как ссылка на обнаруженную проблему)
...
2. `docs/12B_RUNTIME_MASTER_PLAN.md` (главный список runtime-файлов).
3. `docs/07_SCENARIOS_AND_ALGORITHMS.md` (runtime-разделы с `al_*`).
4. `docs/21_ACTIVE_DEVELOPMENT_CONTROL_PANEL.md` (добавить ссылку на mapping appendix при необходимости).

### Wave B (канон/рамки)

5. `docs/12A_WORLD_MODEL_CANON.md`, `docs/12C_PLAYER_PROPERTY_SYSTEM.md`, `docs/12D_WORLD_TRAVEL_CANON.md` — привести scope-блоки к `scripts/daily_life/*` или нейтральной формулировке без жёсткого path.
6. `docs/06_SYSTEM_INVARIANTS.md` и `docs/library/IDEA_CARD_TEMPLATE.md` — убрать legacy путь из инвариантов/шаблонов.

### Wave C (архив/история)

7. `docs/24_DOCUMENTATION_CODE_INSPECTION_2026-04-01.md` оставить как исторический артефакт, но добавить короткую пометку «legacy references preserved intentionally».
...
- `docs/12B_DAILY_LIFE_V1_LEGACY_TO_RUNTIME_MAPPING.md`
