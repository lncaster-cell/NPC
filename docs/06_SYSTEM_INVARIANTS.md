...
Дата синхронизации: 2026-03-13  
Источник: `scripts/ambient_life/*`, `docs/01..05`, `README.md`.  
...
1. **Area-centric execution**  
   Периодическая симуляция инициируется area-уровнем, а не heartbeat для каждого NPC.
...
3. **Bounded processing**  
   Все тяжёлые контуры обязаны иметь budget/cap и не уходить в unbounded-циклы.
...
- Tier-модель (`FREEZE/WARM/HOT`) определяет интенсивность обработки и maintenance.
