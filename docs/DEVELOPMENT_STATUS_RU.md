...
- Текущая стадия City Response:
  ...
  - ✅ identity normalization hardening: offender identity приводится к lower-case перед сборкой cooldown key для стабильного формата и предотвращения регистрозависимого дрейфа.
