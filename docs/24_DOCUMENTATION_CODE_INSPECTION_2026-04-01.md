...
**Наблюдение:**
- В `docs/12B_DAILY_LIFE_V1_DATA_CONTRACTS.md` описаны enum-ветки, которых нет в текущем коде (`DL_SUB_LAW_PATROL`, `DL_DAY_NORMAL`, расширенные override и activity наборы).
...
**Наблюдение:**
- `docs/12B_DAILY_LIFE_V1_RUNTIME_PIPELINE.md` описывает "полноценно только HOT" и "WARM как подготовительный слой".
...
**Наблюдение:**
- `docs/06_SYSTEM_INVARIANTS.md` как источник указывает `scripts/ambient_life/*`.
