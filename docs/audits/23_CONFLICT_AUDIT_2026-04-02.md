...
- `docs/governance/16_IDEA_INVENTORY_AND_SYNC_MAP.md` предупреждает, что для текущего режима нужно ориентироваться на reset-контекст «код удалён, работа только с документацией».
- При этом `README.md`, `docs/governance/21_ACTIVE_DEVELOPMENT_CONTROL_PANEL.md` и `docs/runtime/22_RUNTIME_TRUTH_AND_ACTIVITY_JOURNAL.md` фиксируют активный implementation/runtime режим.
