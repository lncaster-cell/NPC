...
- `docs/runtime/12B_RUNTIME_MASTER_PLAN.md` (множество ссылок на `scripts/ambient_life/al_*.nss`).
- `docs/runtime/07_SCENARIOS_AND_ALGORITHMS.md` (список файлов `al_*`).
- `docs/runtime/10_NPC_RESPAWN_MECHANICS.md` (runtime references на legacy путь).
- `docs/canon/12A_WORLD_MODEL_CANON.md`, `docs/canon/12C_PLAYER_PROPERTY_SYSTEM.md`, `docs/canon/12D_WORLD_TRAVEL_CANON.md` (scope c `scripts/ambient_life/*`).
- `docs/runtime/06_SYSTEM_INVARIANTS.md` и `docs/library/IDEA_CARD_TEMPLATE.md` (legacy-пути в правилах/шаблонах).
...
Симптом:
- В `docs/governance/10_DECISIONS_LOG.md` присутствует строка-шаблон `DEC-XXXX`.
