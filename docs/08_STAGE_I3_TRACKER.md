...
Пока этап находится в статусе `Planned`, детальная документация ведётся прямо в текущем трекере.
После старта реализации следует создать отдельные документы:
