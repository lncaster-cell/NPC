...
> ⚠️ **Актуализация 2026-03-14 (reset):** данный аудит сохранён как исторический срез состояния до удаления runtime-кода. После перехода в режим перепроектирования с нуля формулировки «реализовано в коде» в этом документе трактуются как «было реализовано на предыдущей итерации». Актуальный рабочий контекст зафиксирован в `docs/18_REBUILD_RESET_CONTEXT.md`.
