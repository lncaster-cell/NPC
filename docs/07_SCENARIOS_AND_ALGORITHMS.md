...
> Для обратной совместимости со старыми design-упоминаниями `al_*` см. `docs/12B_DAILY_LIFE_V1_LEGACY_TO_RUNTIME_MAPPING.md`.
...
3. Legacy-обратная совместимость по названиям: `docs/12B_DAILY_LIFE_V1_LEGACY_TO_RUNTIME_MAPPING.md`.
