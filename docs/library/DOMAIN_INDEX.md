...
| Trade and city state | `docs/canon/12E_TRADE_AND_CITY_STATE_CANON.md` | `docs/entry/12_MASTER_PLAN.md`, `docs/governance/16_IDEA_INVENTORY_AND_SYNC_MAP.md` |
| Clan system | `docs/canon/14_CLAN_SYSTEM_DESIGN.md` | `docs/canon/17_UNIFIED_GAME_DESIGN_BRIEF_RU.md`, `docs/canon/12A_WORLD_MODEL_CANON.md`, `docs/canon/12C_PLAYER_PROPERTY_SYSTEM.md`, `docs/governance/16_IDEA_INVENTORY_AND_SYNC_MAP.md` |
| Aging / succession | `docs/canon/13_AGING_AND_CLAN_SUCCESSION.md` | `docs/canon/17_UNIFIED_GAME_DESIGN_BRIEF_RU.md`, `docs/canon/14_CLAN_SYSTEM_DESIGN.md`, `docs/canon/12A_WORLD_MODEL_CANON.md`, `docs/canon/12E_TRADE_AND_CITY_STATE_CANON.md` |
| Documentation governance | `docs/entry/12_MASTER_PLAN.md` | `docs/entry/00_PROJECT_LIBRARY.md`, `docs/governance/10_DECISIONS_LOG.md`, `docs/governance/18_REBUILD_RESET_CONTEXT.md`, `docs/governance/21_ACTIVE_DEVELOPMENT_CONTROL_PANEL.md`, `docs/audits/25_DOCUMENTATION_CODE_INSPECTION_2026-04-02.md` |
| Documentation registry | `docs/library/DOCUMENT_REGISTRY.md` | `docs/entry/00_PROJECT_LIBRARY.md`, `docs/entry/12_MASTER_PLAN.md`, `docs/audits/30_AUDIT_AND_INSPECTION_INDEX.md` |
