...
|---|---|---|
| Runtime architecture | `docs/12B_RUNTIME_MASTER_PLAN.md` | `docs/02_MECHANICS.md`, `docs/03_OPERATIONS.md`, `docs/06_SYSTEM_INVARIANTS.md` |
| World/legal canon | `docs/12A_WORLD_MODEL_CANON.md` | `README.md`, `docs/10_DECISIONS_LOG.md`, `docs/18_REBUILD_RESET_CONTEXT.md` |
