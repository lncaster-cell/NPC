...
> Этот документ является доменной детализацией. Общая каноническая карта проекта фиксируется в `docs/canon/17_UNIFIED_GAME_DESIGN_BRIEF_RU.md`, а `docs/entry/12_MASTER_PLAN.md` используется только как навигационный индекс.
