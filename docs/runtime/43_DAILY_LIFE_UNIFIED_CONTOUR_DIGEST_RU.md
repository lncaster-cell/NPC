...
## 1) Статус и правило использования

Этот digest **заморожен** в рамках жёсткой чистки документационной структуры под единый канон.
Новые изменения контура Daily Life фиксируются только в:
...
> Важно: новые digest-документы не создаются; этот файл оставлен как архивный снимок контекста на момент 2026-04-11.
