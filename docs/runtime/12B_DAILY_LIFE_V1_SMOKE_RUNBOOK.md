...
Runbook покрывает обязательные сценарии из `docs/runtime/12B_DAILY_LIFE_V1_MILESTONE_A_CHECKLIST.md`:
...
1. `docs/runtime/12B_DAILY_LIFE_V1_ACCEPTANCE_JOURNAL.md` → таблица `2.1`;
