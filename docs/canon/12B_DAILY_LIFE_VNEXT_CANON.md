...
> Этот документ детализирует только новую модель Daily Life. Общий high-level канон проекта закреплён в `docs/canon/17_UNIFIED_GAME_DESIGN_BRIEF_RU.md`. Runtime master summary остаётся в `docs/runtime/12B_RUNTIME_MASTER_PLAN.md`.
