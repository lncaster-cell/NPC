# Ambient Life v2 — MASTER PLAN / Том B: runtime-архитектура и операции

Дата: 2026-03-14
Версия: 3 (роль уточнена: runtime master summary)
Статус: сводный runtime master summary (не единственная точка входа в проект)
...
Примечание: этот том является сводным runtime-документом; при изменениях профильных документов (`02/03/04/06/07/08/10`) синхронизация выполняется в этот файл, чтобы не дублировать нормативную логику в нескольких местах.
