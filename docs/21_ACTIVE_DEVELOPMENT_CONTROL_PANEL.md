...
## 0) Быстрый статус на 2026-04-02 (что уже сделано и что можно проверять)
...
- `docs/25_DOCUMENTATION_CODE_INSPECTION_2026-04-02.md` (операционная сверка doc↔code на текущую дату)
